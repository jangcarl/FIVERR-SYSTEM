...
<input class="form-control" disabled="" name="contact_number" type="text" value="&lt;?php echo $userInfo['contact_number']; ?>"/>
</div>
<div class="form-group">
<label for="#">Bio</label>
<textarea class="form-control" disabled="" name="bio_description"><?php echo $userInfo['bio_description']; ?></textarea>
</div>
</div>
</form>
</div>
