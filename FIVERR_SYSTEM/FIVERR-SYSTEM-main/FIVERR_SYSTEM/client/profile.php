...
<div class="col-md-6">
<h1>Your Profile</h1>
<img alt="" class="img-fluid mt-4 mb-4" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"/>
...
<input class="form-control" disabled="" name="username" type="text" value="&lt;?php echo $userInfo['username']; ?>"/>
</div>
<div class="form-group">
<label for="exampleInputEmail1">Email</label>
<input class="form-control" disabled="" name="email" type="email" value="&lt;?php echo $userInfo['email']; ?>"/>
</div>
<div class="form-group">
<label for="exampleInputEmail1">Contact Number</label>
<input class="form-control" name="contact_number" required="" type="text" value="&lt;?php echo $userInfo['contact_number']; ?>"/>
</div>
<div class="form-group">
<label for="#">Bio</label>
<textarea class="form-control" name="bio_description"><?php echo $userInfo['bio_description']; ?></textarea>
</div>
<div class="form-group">
<label for="#">Display Picture</label>
<input class="form-control" name="display_picture" type="file"/>
<input class="mt-4 btn btn-primary float-right" name="updateUserBtn" required="" type="submit"/>
</div>
</div>
</form>
</div>
